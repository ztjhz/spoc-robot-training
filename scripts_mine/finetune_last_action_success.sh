...
#SBATCH --job-name=finetune_last_action_success
...
export WANDB_NOTES="Finetune with last_action_success (fronzen original + train last_action_success + train action classifier)"

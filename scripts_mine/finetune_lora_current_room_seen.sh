...
#SBATCH --job-name=finetune_lora_with_room_current_seen
...
export WANDB_NOTES="Finetune LoRA with room_current_seen (freeze original + train embedding + train LoRA)"
